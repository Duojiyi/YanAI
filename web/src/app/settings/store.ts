    ...
    set((state) => {
      ...
      return {
        config: {
          ...
          image_model_mappings: {
            ...DEFAULT_IMAGE_MODEL_MAPPINGS,
            ...(state.config.image_model_mappings || {}),
            "gpt-image-2": value,
          },
        },
      };
      ...
      registerConfig: {
        ...
        mail: {
          ...
          providers: [
            ...
            { enable: true, type: "moemail", api_base: "https://moemail.app", api_key: "", default_domain: "moemail.app", expiry_time: 3600000 },
          ],
        },
      },
    } : {});
